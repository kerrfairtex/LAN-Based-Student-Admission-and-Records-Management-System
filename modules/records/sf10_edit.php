    ...
    <form method="post">
        ...
        <div class="row g-3 mb-3">
            <div class="col-md-4">
                ...
                <select name="school_year_id" class="form-select" required onchange="this.form.submit()">
            ...
            <div class="col-md-4">
                ...
                <select name="grade_level_id" class="form-select" required onchange="this.form.submit()">
        ...
        <?php if ($input['grade_level_id']): ?>
            ...
            <div class="d-flex gap-2">
                ...
                <a href="/modules/reports/sf10.php?student_id=<?= $studentId ?>&school_year_id=<?= e($input['school_year_id']) ?>&grade_level_id=<?= e($input['grade_level_id']) ?>" class="btn btn-outline-light" target="_blank">Preview SF10</a>
                <a href="/modules/records/view.php?id=<?= $studentId ?>" class="btn btn-outline-light">Back</a>
            </div>
        <?php endif; ?>
    </form>
</div>
